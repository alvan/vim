...
" :'<,'>Align =
" :'<,'>Align = 2
fu! s:Align(key, ...) range
    if a:0
        exe a:firstline . "," . a:lastline . "LineupREN " . a:1 . " " . a:key
    else
        exe a:firstline . "," . a:lastline . "LineupRE " . a:key
    endif
endf
...
" Add by Alvan
com! -range -nargs=* Align <line1>,<line2>call <SID>Align(<f-args>)
