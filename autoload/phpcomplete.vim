    ...
    elseif scontext =~ '\(->\|::\)$'
        ...
        for i in start_list
            if has_key(int_vars, i)
                ...
                let final_list += [{'word':i, 'menu':class.all_values[i]}]
            else
                let final_list +=
                            \ [{'word':substitute(i, '.*::', '', ''),
                            \   'menu':i.all_values[i]}]
    ...
    if a:base =~ '^\$'
        ...
        for i in int_list
            if int_vars[i] != ''
                ...
                let int_dict += [{'word':i, 'menu':class.int_vars[i]}]
            else
                let int_dict += [{'word':i}]
            endif
        endfor
...
function! phpcomplete#LoadData() " {{{
    ...
    let g:php_builtin_functions = {
                ...
                \ 'apc_compile_file': '(string $filename) | bool',
                ...
                \ 'class_alias': '([string $original [, string $alias) | boolean',
                ...
                \ 'counter_bump': '(integer $offset) | void',
                \ 'counter_bump_value': '(resource $counter , integer $offset) | void',
                \ 'counter_create': '(string $name [, integer $initial_value) | resource',
                \ 'counter_get': '(void) | integer',
                \ 'counter_get_meta': '(resource $counter , integer $attribute) | mixed',
                ...
                \ 'db2_last_insert_id': '(resource $resource) | int',
                ...
                \ 'event_set': '(resource $event , resource $fd) | bool',
                ...
                \ 'finfo_buffer': '(resource $finfo , string $string = NULL) | string',
                \ 'finfo_close': '(resource $finfo) | bool',
                \ 'finfo_file': '(resource $finfo , string $file_name = NULL) | string',
                \ 'finfo_open': '([int $options = FILEINFO_NONE) | resource',
                ...
                \ 'grapheme_extract': '(string $haystack) | string',
                \ 'grapheme_stripos': '(string $haystack) | int',
                \ 'grapheme_stristr': '(string $haystack) | string',
                \ 'grapheme_strlen': '(string $input) | int',
                \ 'grapheme_strpos': '(string $haystack) | int',
                \ 'grapheme_strripos': '(string $haystack) | int',
                \ 'grapheme_strrpos': '(string $haystack) | int',
                \ 'grapheme_strstr': '(string $haystack) | string',
                \ 'grapheme_substr': '(string $string) | int',
                ...
                \ 'gupnp_context_new': '([string $host_ip [, int $port) | resource',
                \ 'gupnp_context_set_subscription_timeout': '(resource $context , int $timeout) | void',
                \ 'gupnp_context_timeout_add': '(int $timeout , mixed $callback) | bool',
                ...
                \ 'gupnp_service_proxy_action_get': '(resource $proxy , string $action) | bool',
                ...
                \ 'http_match_modified': '([int $timestamp [, bool $for_range = false) | bool',
                ...
                \ 'http_redirect': '([string $url [, array $params) | void',
                ...
                \ 'http_send_last_modified': '([int $timestamp]) | bool',
                ...
                \ 'idn_to_ascii': '(string $domain) | string',
                \ 'idn_to_utf8': '(string $domain) | string',
                ...
                \ 'imagegrabwindow': '(int $window [, int $client_area = 0) | resource',
                ...
                \ 'imap_gc': '(resource $imap_stream , int $caches) | string',
                ...
                \ 'ingres_execute': '(resource $result [, array $params) | boolean',
                ...
                \ 'ingres_result_seek': '(resource $result , integer $position) | boolean',
                ...
                \ 'is_binary': '(mixed $var) | bool',
                \ 'is_bool': '(mixed var) | bool',
                \ 'is_buffer': '(mixed $var) | bool',
                ...
                \ 'libxml_disable_entity_loader': '([bool $disable = TRUE]) | ReturnType',
                ...
                \ 'locale_set_default': '(string $name) | bool',
                ...
                \ 'maxdb_fetch_array': '(resource $result) | mixed',
                \ 'maxdb_fetch_assoc': '(resource $result) | array',
                \ 'maxdb_fetch_field': '(resource $result) | mixed',
                \ 'maxdb_fetch_field_direct': '(resource $result) | mixed',
                ...
                \ 'maxdb_field_seek': '(resource $result) | bool',
                ...
                \ 'maxdb_kill': '(resource $link) | bool',
                \ 'maxdb_master_query': '(resource link, string query) | bool',
                \ 'maxdb_more_results': '(resource link) | bool',
                \ 'maxdb_multi_query': '(resource $link) | bool',
                \ 'maxdb_next_result': '(resource link) | bool',
                \ 'maxdb_num_fields': '(resource $result) | int',
                \ 'maxdb_num_rows': '(resource $result) | int',
                \ 'maxdb_options': '(resource $link) | bool',
                \ 'maxdb_ping': '(resource $link) | bool',
                \ 'maxdb_prepare': '(resource $link) | resource',
                \ 'maxdb_query': '(resource $link) | mixed',
                \ 'maxdb_real_connect': '(resource $link) | bool',
                \ 'maxdb_real_escape_string': '(resource $link) | string',
                \ 'maxdb_real_query': '(resource $link) | bool',
                ...
                \ 'maxdb_ssl_set': '(resource $link) | bool',
                \ 'maxdb_stat': '(resource $link) | string',
                \ 'maxdb_stmt_affected_rows': '(resource $stmt) | int',
                \ 'maxdb_stmt_bind_param': '(resource $stmt) | bool',
                \ 'maxdb_stmt_bind_result': '(resource $stmt) | bool',
                \ 'maxdb_stmt_close': '(resource $stmt) | bool',
                \ 'maxdb_stmt_close_long_data': '(resource $stmt) | bool',
                \ 'maxdb_stmt_data_seek': '(resource $statement) | bool',
                ...
                \ 'mysqli_rpl_query_type': '(mysqli $link) | int',
                \ 'mysqli_select_db': '(mysqli link, string dbname) | bool',
                \ 'mysqli_send_query': '(mysqli $link) | bool',
                ...
                \ 'mysqli_set_local_infile_handler': '(mysqli $link , callback $read_func) | bool',
                ...
                \ 'openssl_random_pseudo_bytes': '(string $length , string $strong) | bool',
                ...
                \ 'snmp_set_oid_output_format': '(int $oid_format) | void',
                ...
                \ 'stream_resolve_include_path': '(string $filename [, resource $context) | string',
                ...
                \ 'tidy_get_opt_doc': '(tidy $object) | string',
                ...
                \ 'umask': '([int mask]) | int',
                \ 'unicode_decode': '(string $input , string $encoding) | unicode',
                \ 'unicode_encode': '(unicode input, string encoding) | string',
                \ 'unicode_get_error_mode': '(int $direction) | int',
                \ 'unicode_get_subst_char': '(void) | unicode',
                \ 'unicode_semantics': '(void) | bool',
                \ 'unicode_set_error_mode': '(int $direction , int $mode) | bool',
                \ 'unicode_set_subst_char': '(unicode $character) | bool',
    ...
    let g:php_builtin_object_functions = {
                ...
                \ 'ArrayObject::getIteratorClass': '(void) | int',
                ...
                \ 'ArrayObject::uasort': '(callback $cmp_function) | void',
                \ 'ArrayObject::uksort': '(callback $cmp_function) | void',
                ...
                \ 'Counter::bumpValue': '(integer $offset) | void',
                \ 'Counter::getMeta': '(integer $attribute) | mixed',
                \ 'Counter::getValue': '(void) | integer',
                ...
                \ 'DOMCharacterData::replaceData': '(int $offset , int $count) | void',
                ...
                \ 'DOMDocument::createElementNS': '(string $namespaceURI , string $qualifiedName) | DOMElement',
                ...
                \ 'DOMElement::setAttributeNS': '(string $namespaceURI , string $qualifiedName) | void',
                ...
                \ 'DOMElement::setIdAttributeNS': '(string $namespaceURI , string $localName) | void',
                ...
                \ 'DOMXPath::evaluate': '(string $expression [, DOMNode $contextnode) | mixed',
                \ 'DOMXPath::query': '(string $expression [, DOMNode $contextnode) | DOMNodeList',
                ...
                \ 'HaruAnnotation::setBorderStyle': '(float $width , int $dash_on) | bool',
                ...
                \ 'HaruDestination::setFitR': '(float $left , float $bottom) | bool',
                \ 'HaruDestination::setFitV': '(float $left) | bool',
                \ 'HaruDestination::setXYZ': '(float $left , float $top) | bool',
                \ 'HaruDoc::__construct': '(void) | void',
                \ 'HaruDoc::addPage': '(void) | object',
                \ 'HaruDoc::addPageLabel': '(int $first_page , int $style) | bool',
                \ 'HaruDoc::createOutline': '(string $title [, object $parent_outline) | object',
                ...
                \ 'HaruDoc::loadRaw': '(string $filename , int $width) | object',
                \ 'HaruDoc::loadTTC': '(string $fontfile , int $index) | string',
                ...
                \ 'HaruDoc::setInfoDateAttr': '(int $type , int $year) | bool',
                ...
                \ 'HaruFont::measureText': '(string $text , float $width) | int',
                ...
                \ 'HaruImage::setColorMask': '(int $rmin , int $rmax) | bool',
                ...
                \ 'HaruPage::arc': '(float $x , float $y) | bool',
                \ 'HaruPage::beginText': '(void) | bool',
                \ 'HaruPage::circle': '(float $x , float $y) | bool',
                \ 'HaruPage::closePath': '(void) | bool',
                \ 'HaruPage::concat': '(float $a , float $b) | bool',
                \ 'HaruPage::createDestination': '(void) | object',
                \ 'HaruPage::createLinkAnnotation': '(array $rectangle , object $destination) | object',
                \ 'HaruPage::createTextAnnotation': '(array $rectangle , string $text) | object',
                \ 'HaruPage::createURLAnnotation': '(array $rectangle , string $url) | object',
                \ 'HaruPage::curveTo': '(float $x1 , float $y1) | bool',
                \ 'HaruPage::curveTo2': '(float $x2 , float $y2) | bool',
                \ 'HaruPage::curveTo3': '(float $x1 , float $y1) | bool',
                \ 'HaruPage::drawImage': '(object $image , float $x) | bool',
                \ 'HaruPage::ellipse': '(float $x , float $y) | bool',
                ...
                \ 'HaruPage::measureText': '(string $text , float $width) | int',
                \ 'HaruPage::moveTextPos': '(float $x , float $y) | bool',
                \ 'HaruPage::moveTo': '(float $x , float $y) | bool',
                \ 'HaruPage::moveToNextLine': '(void) | bool',
                \ 'HaruPage::rectangle': '(float $x , float $y) | bool',
                \ 'HaruPage::setCMYKFill': '(float $c , float $m) | bool',
                \ 'HaruPage::setCMYKStroke': '(float $c , float $m) | bool',
                ...
                \ 'HaruPage::setRGBFill': '(float $r , float $g) | bool',
                \ 'HaruPage::setRGBStroke': '(float $r , float $g) | bool',
                \ 'HaruPage::setRotate': '(int $angle) | bool',
                \ 'HaruPage::setSize': '(int $size , int $direction) | bool',
                \ 'HaruPage::setSlideShow': '(int $type , float $disp_time) | bool',
                \ 'HaruPage::setTextLeading': '(float $text_leading) | bool',
                \ 'HaruPage::setTextMatrix': '(float $a , float $b) | bool',
                ...
                \ 'HaruPage::showTextNextLine': '(string $text [, float $word_space) | bool',
                \ 'HaruPage::stroke': '([bool $close_path = false]) | bool',
                \ 'HaruPage::textOut': '(float $x , float $y) | bool',
                \ 'HaruPage::textRect': '(float $left , float $top) | bool',
                \ 'HttpRequestPool::__construct': '([HttpRequest $request]) | void',
                ...
                \ 'Imagick::__construct': '([mixed $files]) | Imagick',
                \ 'Imagick::adaptiveBlurImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::adaptiveResizeImage': '(int $columns , int $rows) | bool',
                \ 'Imagick::adaptiveSharpenImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::adaptiveThresholdImage': '(int $width , int $height) | bool',
                ...
                \ 'Imagick::animateImages': '(string $x_server(array $matrix)) | bool',
                \ 'Imagick::annotateImage': '(ImagickDraw $draw_settings , float $x) | bool',
                ...
                \ 'Imagick::blurImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::borderImage': '(mixed $bordercolor , int $width) | bool',
                \ 'Imagick::charcoalImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::chopImage': '(int $width , int $height) | bool',
                ...
                \ 'Imagick::colorFloodfillImage': '(mixed $fill , float $fuzz) | bool',
                ...
                \ 'Imagick::compareImageChannels': '(Imagick $image , int $channelType) | array',
                \ 'Imagick::compareImageLayers': '(int $method) | Imagick',
                \ 'Imagick::compareImages': '(Imagick $compare , int $metric) | array',
                \ 'Imagick::compositeImage': '(Imagick $composite_object , int $composite) | bool',
                \ 'Imagick::contrastImage': '(bool $sharpen) | bool',
                \ 'Imagick::contrastStretchImage': '(float $black_point , float $white_point) | bool',
                \ 'Imagick::convolveImage': '(array $kernel [, int $channel = Imagick::CHANNEL_ALL) | bool',
                \ 'Imagick::cropImage': '(int $width , int $height) | bool',
                ...
                \ 'Imagick::deconstructImages': '(void) | bool',
                ...
                \ 'Imagick::distortImage': '(int $method , array $arguments) | bool',
                ...
                \ 'Imagick::evaluateImage': '(int $op , float $constant) | bool',
                \ 'Imagick::extentImage': '(int $width , int $height) | bool',
                \ 'Imagick::flattenImages': '(void) | Imagick',
                \ 'Imagick::flipImage': '(void) | bool',
                \ 'Imagick::floodFillPaintImage': '(mixed $fill , float $fuzz) | bool',
                \ 'Imagick::flopImage': '(void) | bool',
                \ 'Imagick::frameImage': '(mixed $matte_color , int $width) | bool',
                ...
                \ 'Imagick::gaussianBlurImage': '(float $radius , float $sigma) | bool',
                ...
                \ 'Imagick::getImageBluePrimary': '(float $x , float $y) | array',
                \ 'Imagick::getImageBorderColor': '(void) | ImagickPixel',
                \ 'Imagick::getImageChannelDepth': '(int $channel) | int',
                \ 'Imagick::getImageChannelDistortion': '(Imagick $reference , int $channel) | float',
                \ 'Imagick::getImageChannelDistortions': '(Imagick $reference , int $metric) | double',
                \ 'Imagick::getImageChannelExtrema': '(int $channel) | array',
                \ 'Imagick::getImageChannelMean': '(int $channel) | array',
                \ 'Imagick::getImageChannelRange': '(int $channel) | bool',
                ...
                \ 'Imagick::getImageRegion': '(int $width , int $height) | Imagick',
                ...
                \ 'Imagick::getPixelRegionIterator': '(int $x , int $y) | ImagickPixelIterator',
                ...
                \ 'Imagick::levelImage': '(float $blackPoint , float $gamma) | bool',
                \ 'Imagick::linearStretchImage': '(float $blackPoint , float $whitePoint) | bool',
                \ 'Imagick::liquidRescaleImage': '(int $width , int $height) | bool',
                \ 'Imagick::magnifyImage': '(void) | bool',
                \ 'Imagick::mapImage': '(Imagick $map , bool $dither) | bool',
                \ 'Imagick::matteFloodfillImage': '(float $alpha , float $fuzz) | bool',
                \ 'Imagick::medianFilterImage': '(float $radius) | bool',
                \ 'Imagick::mergeImageLayers': '(int $layer_method) | bool',
                \ 'Imagick::minifyImage': '(void) | bool',
                \ 'Imagick::modulateImage': '(float $brightness , float $saturation) | bool',
                \ 'Imagick::montageImage': '(ImagickDraw $draw , string $tile_geometry) | Imagick',
                \ 'Imagick::morphImages': '(int $number_frames) | Imagick',
                \ 'Imagick::mosaicImages': '(void) | Imagick',
                \ 'Imagick::motionBlurImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::negateImage': '(bool $gray [, int $channel = Imagick::CHANNEL_ALL) | bool',
                \ 'Imagick::newImage': '(int $cols , int $rows) | bool',
                \ 'Imagick::newPseudoImage': '(int $columns , int $rows) | bool',
                \ 'Imagick::nextImage': '(void) | bool',
                \ 'Imagick::normalizeImage': '([int $channel]) | bool',
                \ 'Imagick::oilPaintImage': '(float $radius) | bool',
                \ 'Imagick::opaquePaintImage': '(mixed $target , mixed $fill) | bool',
                ...
                \ 'Imagick::paintFloodfillImage': '(mixed $fill , float $fuzz) | bool',
                \ 'Imagick::paintOpaqueImage': '(mixed $target , mixed $fill) | bool',
                \ 'Imagick::paintTransparentImage': '(mixed $target , float $alpha) | bool',
                ...
                \ 'Imagick::quantizeImage': '(int $numberColors , int $colorspace) | bool',
                \ 'Imagick::quantizeImages': '(int $numberColors , int $colorspace) | bool',
                \ 'Imagick::queryFontMetrics': '(ImagickDraw $properties , string $text) | array',
                \ 'Imagick::radialBlurImage': '(float $angle [, int $channel = Imagick::CHANNEL_ALL) | bool',
                \ 'Imagick::raiseImage': '(int $width , int $height) | bool',
                \ 'Imagick::randomThresholdImage': '(float $low , float $high) | bool',
                \ 'Imagick::readImage': '(string $filename) | bool',
                \ 'Imagick::readImageBlob': '(string $image [, string $filename) | bool',
                \ 'Imagick::readImageFile': '(resource $filehandle [, string $fileName) | bool',
                ...
                \ 'Imagick::resampleImage': '(float $x_resolution , float $y_resolution) | bool',
                \ 'Imagick::resetImagePage': '(string $page) | bool',
                \ 'Imagick::resizeImage': '(int $columns , int $rows) | bool',
                \ 'Imagick::rollImage': '(int $x , int $y) | bool',
                \ 'Imagick::rotateImage': '(mixed $background , float $degrees) | bool',
                \ 'Imagick::roundCorners': '(float $x_rounding , float $y_rounding) | bool',
                \ 'Imagick::sampleImage': '(int $columns , int $rows) | bool',
                \ 'Imagick::scaleImage': '(int $cols , int $rows) | bool',
                ...
                \ 'Imagick::setImagePage': '(int $width , int $height) | bool',
                ...
                \ 'Imagick::setPage': '(int $width , int $height) | bool',
                ...
                \ 'Imagick::setSizeOffset': '(int $columns , int $rows) | bool',
                \ 'Imagick::setType': '(int $image_type) | bool',
                \ 'Imagick::shadeImage': '(bool $gray , float $azimuth) | bool',
                \ 'Imagick::shadowImage': '(float $opacity , float $sigma) | bool',
                \ 'Imagick::sharpenImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::shaveImage': '(int $columns , int $rows) | bool',
                \ 'Imagick::shearImage': '(mixed $background , float $x_shear) | bool',
                \ 'Imagick::sigmoidalContrastImage': '(bool $sharpen , float $alpha) | bool',
                \ 'Imagick::sketchImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::solarizeImage': '(int $threshold) | bool',
                \ 'Imagick::spliceImage': '(int $width , int $height) | bool',
                ...
                \ 'Imagick::thumbnailImage': '(int $columns , int $rows) | bool',
                \ 'Imagick::tintImage': '(mixed $tint , mixed $opacity) | bool',
                \ 'Imagick::transformImage': '(string $crop , string $geometry) | Imagick',
                \ 'Imagick::transparentPaintImage': '(mixed $target , float $alpha) | bool',
                ...
                \ 'Imagick::unsharpMaskImage': '(float $radius , float $sigma) | bool',
                \ 'Imagick::valid': '(void) | bool',
                \ 'Imagick::vignetteImage': '(float $blackPoint , float $whitePoint) | bool',
                ...
                \ 'ImagickDraw::__construct': '(void) | ImagickDraw',
                \ 'ImagickDraw::affine': '(array $affine) | bool',
                \ 'ImagickDraw::annotation': '(float $x , float $y) | bool',
                \ 'ImagickDraw::arc': '(float $sx , float $sy) | bool',
                \ 'ImagickDraw::bezier': '(array $coordinates) | bool',
                \ 'ImagickDraw::circle': '(float $ox , float $oy) | bool',
                \ 'ImagickDraw::clear': '(void) | bool',
                \ 'ImagickDraw::clone': '(void) | ImagickDraw',
                \ 'ImagickDraw::color': '(float $x , float $y) | bool',
                \ 'ImagickDraw::comment': '(string $comment) | bool',
                \ 'ImagickDraw::composite': '(int $compose , float $x) | bool',
                \ 'ImagickDraw::destroy': '(void) | bool',
                \ 'ImagickDraw::ellipse': '(float $ox , float $oy) | bool',
                ...
                \ 'ImagickDraw::getStrokeColor': '(ImagickPixel $stroke_color) | ImagickPixel',
                ...
                \ 'ImagickDraw::line': '(float $sx , float $sy) | bool',
                \ 'ImagickDraw::matte': '(float $x , float $y) | bool',
                \ 'ImagickDraw::pathClose': '(void) | bool',
                \ 'ImagickDraw::pathCurveToAbsolute': '(float $x1 , float $y1) | bool',
                \ 'ImagickDraw::pathCurveToQuadraticBezierAbsolute': '(float $x1 , float $y1) | bool',
                \ 'ImagickDraw::pathCurveToQuadraticBezierRelative': '(float $x1 , float $y1) | bool',
                ...
                \ 'ImagickDraw::pathCurveToRelative': '(float $x1 , float $y1) | bool',
                \ 'ImagickDraw::pathCurveToSmoothAbsolute': '(float $x2 , float $y2) | bool',
                \ 'ImagickDraw::pathCurveToSmoothRelative': '(float $x2 , float $y2) | bool',
                \ 'ImagickDraw::pathEllipticArcAbsolute': '(float $rx , float $ry) | bool',
                \ 'ImagickDraw::pathEllipticArcRelative': '(float $rx , float $ry) | bool',
                ...
                \ 'ImagickDraw::pushPattern': '(string $pattern_id , float $x) | bool',
                \ 'ImagickDraw::rectangle': '(float $x1 , float $y1) | bool',
                \ 'ImagickDraw::render': '(void) | bool',
                \ 'ImagickDraw::rotate': '(float $degrees) | bool',
                \ 'ImagickDraw::roundRectangle': '(float $x1 , float $y1) | bool',
                ...
                \ 'ImagickPixel::setHSL': '(float $hue , float $saturation) | bool',
                \ 'ImagickPixelIterator::__construct': '(Imagick $wand) | ImagickPixelIterator',
                ...
                \ 'ImagickPixelIterator::newPixelRegionIterator': '(Imagick $wand , int $x) | bool',
                ...
                \ 'Memcache::setServerParams': '(string $host [, int $port) | bool',
                \ 'MongoBinData::__construct': '(string $data [, int $type) | public',
                ...
                \ 'PDO::pgsqlLOBCreate': '(void) | string',
                \ 'PDO::pgsqlLOBOpen': '(string $oid [, string $mode = "rb") | resource',
                ...
                \ 'Phar::__construct': '(string $fname [, int $flags) | void',
                ...
                \ 'Phar::convertToData': '([int $format = 9021976 [, int $compression = 9021976) | PharData',
                \ 'Phar::convertToExecutable': '([int $format = 9021976 [, int $compression = 9021976) | Phar',
                ...
                \ 'Phar::extractTo': '(string $pathto [, string|array $files]) | bool',
                ...
                \ 'Phar::webPhar': '([string $alias [, string $index) | void',
                \ 'PharData::__construct': '(string $fname [, int $flags) | void',
                ...
                \ 'PharData::convertToData': '([int $format [, int $compression) | PharData',
                \ 'PharData::convertToExecutable': '([int $format [, int $compression) | Phar',
                ...
                \ 'PharData::delMetadata': '(void) | int',
                \ 'PharData::delete': '(string $entry) | int',
                \ 'PharData::extractTo': '(string $pathto [, string|array $files]) | int',
                ...
                \ 'PharData::setDefaultStub': '([string $index [, string $webindex) | void',
                \ 'PharData::setStub': '(string $stub) | void',
                \ 'PharFileInfo::__construct': '(string $entry) | void',
                ...
                \ 'RecursiveRegexIterator::__construct': '(RecursiveIterator $iterator , string $regex) | public',
                ...
                \ 'SCA::createDataObject': '() | SDO_DataObject',
                \ 'SCA::getService': '() | mixed',
                \ 'SCA_LocalProxy::createDataObject': '() | SDO_DataObject',
                \ 'SCA_SoapProxy::createDataObject': '() | SDO_DataObject',
                ...
                \ 'SplFixedArray::__construct': '(int $size) | public',
                \ 'SplHeap::compare': '(mixed $value1 , mixed $value2) | abstractint',
                ...
                \ 'SplMaxHeap::compare': '(mixed $value1 , mixed $value2) | void',
                \ 'SplMinHeap::compare': '(mixed $value1 , mixed $value2) | void',
                \ 'SplPriorityQueue::compare': '(mixed $priority1 , mixed $priority2) | void',
                ...
                \ 'SwishSearch::setLimit': '(string $property , string $low) | void',
                ...
                \ 'XMLReader::moveToAttributeNs': '(string $localName) | bool',
                ...
                \ 'XMLReader::open': '(string $URI) | bool',
                ...
                \ 'XMLReader::setParserProperty': '(int $property) | bool',
                ...
                \ 'XMLReader::xml': '(string $source) | bool',
                \ 'ZipArchive::addEmptyDir': '(string $dirname) | bool',
                \ 'ZipArchive::addFile': '(string $filename [, string $localname) | bool',
                ...
                \ 'ZipArchive::getArchiveComment': '(void) | string',
                \ 'ZipArchive::getCommentIndex': '(int $index [, int $flags) | string',
                \ 'ZipArchive::getCommentName': '(string $name [, int $flags) | string',
                \ 'ZipArchive::getFromIndex': '(int $index [, int $flags) | mixed',
                \ 'ZipArchive::getFromName': '(string $name [, int $flags) | mixed',
                \ 'ZipArchive::getNameIndex': '(int $index) | string',
                ...
                \ 'ZipArchive::statName': '(name $name [, int $flags) | mixed',
                ...
                \ 'mysqli::change_user': '(string $user) | bool',
                ...
                \ 'mysqli::get_cache_stats': '(void) | bool',
                \ 'mysqli::get_charset': '(void) | object',
                \ 'mysqli::get_client_info': '(void) | string',
                \ 'mysqli::get_client_stats': '(void) | bool',
                \ 'mysqli::get_client_version': '(void) | int',
                \ 'mysqli::get_connection_stats': '(void) | bool',
                \ 'mysqli::get_warnings': '(void) | object',
                ...
                \ 'mysqli::options': '(int $option) | bool',
                \ 'mysqli::ping': '(void) | bool',
                \ 'mysqli::prepare': '(string $query) | mysqli_stmt',
                \ 'mysqli::query': '(string $query) | mixed',
                \ 'mysqli::real_connect': '([string $host) | bool',
                ...
                \ 'mysqli::ssl_set': '(string $key) | bool',
                ...
                \ 'mysqli_driver::embedded_server_start': '(bool $start , array $arguments) | bool',
                \ 'mysqli_result::data_seek': '(int $offset) | bool',
                \ 'mysqli_result::fetch_all': '([int $resulttype) | mixed',
                \ 'mysqli_result::fetch_array': '([int $resulttype) | mixed',
                ...
                \ 'mysqli_result::fetch_object': '([string $class_name) | object',
                ...
                \ 'mysqli_stmt::attr_set': '(int $attr) | bool',
                \ 'mysqli_stmt::bind_param': '(string $types) | bool',
                \ 'mysqli_stmt::bind_result': '(mixed &$var1) | bool',
                ...
                \ 'mysqli_stmt::send_long_data': '(int $param_nr) | bool',
