...
"        Author:  Alvan
"      Modifier:  Alvan
"      Modified:  2012-01-16 10:30:30  
"   Description:  Auto close xml tag.
"                 Based on xml.vim(http://www.vim.org/scripts/script.php?script_id=1397)
"
"                 Put those below into your .vimrc:
"                 au BufNewFile,Bufread *.html,*.xhtml,*.phtml source $VIMDIR/scripts/closetag.vim
"
" --}}}
"
